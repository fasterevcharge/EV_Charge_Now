...
export async function POST(request: Request) {
  ...
  await resend.emails
    .send({
      ...
      subject: "Thanks for contacting Faster EV Charge Now",
          ...
          <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:14px;overflow:hidden;border:1px solid #e5e5e7;">
            <tr>
              <td style="background:#ffffff;padding:32px 40px 24px;border-bottom:1px solid #efeff1;" align="center">
                <img src="https://fasterevchargenow.com/email-logo.png" alt="Faster EV Charge Now" width="360" style="display:block;width:100%;max-width:360px;height:auto;" />
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:36px 40px 8px;font-family:Helvetica,Arial,sans-serif;">
                ...
                <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#3f3f46;">
                  We've received your message and a member of the Faster EV Charge Now team will get back to you within one to two business days.
                </p>
                <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#3f3f46;">
            ...
            <tr>
              <td style="padding:24px 40px 36px;font-family:Helvetica,Arial,sans-serif;">
                <p style="margin:0;font-size:15px;line-height:1.6;color:#3f3f46;">
                  Warm regards,<br />
                  <strong style="color:#0b0c0e;">The Faster EV Charge Now Team</strong>
                </p>
              </td>
            </tr>
            <tr>
